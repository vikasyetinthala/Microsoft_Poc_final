...
logger.addHandler(AzureLogHandler(connection_string='InstrumentationKey=53474f24-f026-4bb5-a3d6-b293e313078b'))
...
custom_dimensions["score"]=score
logger.info(f"accuracy of model is {score}",extra=custom_dimensions_score)
